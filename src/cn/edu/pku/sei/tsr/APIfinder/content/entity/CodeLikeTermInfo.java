...
public class CodeLikeTermInfo implements UUIDInterface, Serializable {
	...
	public void setSimilarTypeCodeElementList(
			Map<JavaBaseInfo, Double> similarTypeCodeElementList) {
	...
	public void setSimilarMethodCodeElementList(
			Map<JavaBaseInfo, Double> similarMethodCodeElementList) {
	...
	public void setRelevantCodeElement(JavaBaseInfo relevantCodeElement) {
		...
		if (relevantCodeElement != null){
			if (relevantCodeElement instanceof JavaMethodInfo){
				this.relevantCodeElementFQN = 
						((JavaMethodInfo)relevantCodeElement).toString() + "(" +
						((JavaMethodInfo)relevantCodeElement).getSign() + ")";
			}else{
