...
import cn.edu.pku.sei.tsr.APIfinder.utils.nlp.StanfordCoreSplit;
import cn.edu.pku.sei.tsr.APIfinder.utils.nlp.StanfordParser;
...
public class SentenceParser {
	...
	public static void parseGrammaticalTree(SentenceInfo sentence) {
		...
		sentence.setGrammaticalTree(tree);
	}
	...
	// public static List<String> getSentenceList(ThreadInfo tInfo) {
	...
	//
	// public static void separateParagraphToSentencesInThread(ThreadInfo thread) {
