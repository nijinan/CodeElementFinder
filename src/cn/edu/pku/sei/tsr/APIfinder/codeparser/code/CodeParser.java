...
import cn.edu.pku.sei.tsr.APIfinder.utils.FileUtils;
...
//		parse("lucene", "D:\\Dragon Project\\subjects\\lucene-5.2.1\\core\\src\\java").printAllClassesAndInterfaces();
		JavaProjectInfo project = parse("lucene", "D:\\Codes\\lucene-5.2.1");
		JavaClassInfo c = project.getPackage("org.apache.lucene.search", false).getClass("BooleanQuery");
		for (JavaMethodInfo m : c.getMethods())
		System.out.println(m.getFullyQualifiedName() + " " + m.getSign());
